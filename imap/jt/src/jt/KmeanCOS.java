...
public class KmeanCOS extends Configured implements Tool {
	...
	private void iterateKMeans(String input, String output) throws IOException {
		...
		job.setJarByClass(KmeanCOS.class);
		job.setOutputFormat(TextOutputFormat.class);
		job.setMapperClass(KMeansMapCOS.class);
		job.setReducerClass(KMeansReduceCOS.class);
...
//		for(Object ar:other_args){ System.out.println((String)ar);}
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new KmeanCOS(), args);
		System.exit(res);
	}
}