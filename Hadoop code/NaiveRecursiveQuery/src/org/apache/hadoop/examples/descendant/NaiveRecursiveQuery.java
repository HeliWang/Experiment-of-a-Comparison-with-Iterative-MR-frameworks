...
/*
 * Haejoon Lee modified Recursive Query on 2015.01.17 
 */
...
public class NaiveRecursiveQuery {
...
*/
	public static class JoinMap extends MapReduceBase implements
		...
		public void configure(JobConf job) {
			currentIteration = job.getInt("iteration", -1);			
		...
		public void map(LongWritable key, Text value,
			...
			if (currentIteration == 0) {
				...
				System.err.println(currentIteration +" tag1: "+leftStr+ " / " + rightStr);
				if (lineSize == 3) {
					outputKey.setFirstText(rightStr);
					outputKey.setSecondText(tag0);
					outputValue.setFirstText(leftStr);
	...
	public static void main(String[] args) throws Exception {
		...
		JobConf conf = new JobConf(NaiveRecursiveQuery.class);
		...
		do {
			/**************** Join Job **********************/
			conf = new JobConf(NaiveRecursiveQuery.class);
