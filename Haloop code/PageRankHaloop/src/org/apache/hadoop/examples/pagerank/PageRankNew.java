...
public class PageRankNew {
	...
	public static void main(String[] args) throws Exception {
		...
		totalSum += (joinEnd - joinStart);
		localTotalSum += (joinEnd - joinStart);
		JobClient.runJob(conf);
		long end = System.currentTimeMillis();
		System.out.println("fixpoint time " + (totalSum) / 1000 + "s");
		System.out.println("fixpoint time " + (localTotalSum) / 1000 + "s");
